...
async def join_channel(event):
    ...
    try:
        ...
        await shahm1(JoinChannelRequest("@GG5F5Gt"))
...
async def join_channel(event):
    ...
    try:
        ...
        await shahm1(JoinChannelRequest("@U_T_L"))
...
@shahm1.on(events.NewMessage(outgoing=False, pattern='.فحص'))
...
@shahm1.on(events.NewMessage(outgoing=False, pattern='/افحص'))
...
⚝ مرحبا بك في اوامر ابن مصر بـوينت
...
@shahm1.on(events.NewMessage(outgoing=False, pattern='.التجميع'))
...
@shahm1.on(events.NewMessage(outgoing=False, pattern='.التحكم'))
...
@shahm1.on(events.NewMessage(outgoing=False, pattern='.المميزة'))
...
@shahm1.on(events.NewMessage(outgoing=False, pattern='/notes'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await shahm1(JoinChannelRequest('GG5F5Gt'))
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                ...
                await shahm1.send_message(event.chat_id, f"تم الانتهاء من التجميع | Egypt")
        ...
        await shahm1.send_message(event.chat_id, "تم الانتهاء من التجميع | Egypt")
...
async def _(event):
    ...
    joinu = await shahm1(JoinChannelRequest('TT6T5Y'))
    ...
    while True:
        ...
        try:
            ...
            if sender.id == ownerhson_id:
                ...
                await shahm1.send_message(pot, '**جاري بدأ عملية التجميع بواسطة شهم**')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        await shahm1.send_message(event.chat_id, "تم اعادة تشغيل السورس ")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joini = await shahm1(JoinChannelRequest('B_Q_5'))





        joino = await shahm1(JoinChannelRequest('GG5F5Gt'))





        joinp = await shahm1(JoinChannelRequest('GG5F5Gt'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await shahm1(JoinChannelRequest('ql8ql'))
